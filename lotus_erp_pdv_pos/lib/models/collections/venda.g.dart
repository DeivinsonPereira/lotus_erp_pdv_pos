...
venda _vendaDeserialize(
  ...
  final object = venda(
    cpf_cnpj: reader.readString(offsets[0]),
    data: reader.readDateTime(offsets[1]),
    enviado: reader.readLong(offsets[2]),
    hora: reader.readString(offsets[3]),
    id_caixa: reader.readLong(offsets[4]),
    id_colaborador: reader.readLong(offsets[5]),
    id_empresa: reader.readLong(offsets[6]),
    id_serie_nfce: reader.readLong(offsets[7]),
    id_usuario: reader.readLong(offsets[8]),
    id_venda_servidor: reader.readLong(offsets[9]),
    status: reader.readLong(offsets[10]),
    tot_bruto: reader.readDouble(offsets[11]),
    tot_desc_prc: reader.readDouble(offsets[12]),
    tot_desc_vlr: reader.readDouble(offsets[13]),
    tot_liquido: reader.readDouble(offsets[14]),
    valor_troco: reader.readDouble(offsets[15]),
  );
  object.id_venda = id;
  return object;
}
