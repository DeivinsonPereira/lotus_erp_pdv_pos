...
venda_item _venda_itemDeserialize(
  ...
  final object = venda_item(
    grade: reader.readStringOrNull(offsets[0]),
    id_produto: reader.readLong(offsets[1]),
    id_venda: reader.readLong(offsets[2]),
    item: reader.readLong(offsets[3]),
    qtde: reader.readDoubleOrNull(offsets[4]),
    tot_bruto: reader.readDoubleOrNull(offsets[5]),
    vlr_vendido: reader.readDoubleOrNull(offsets[6]),
  );
  object.id = id;
  return object;
}
