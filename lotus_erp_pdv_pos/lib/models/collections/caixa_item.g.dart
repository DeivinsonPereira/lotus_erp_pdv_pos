...
caixa_item _caixa_itemDeserialize(
  ...
  final object = caixa_item(
    ...
    id_tipo_recebimento: reader.readLong(offsets[5]),
    id_venda: reader.readLongOrNull(offsets[6]),
    valor_cre: reader.readDoubleOrNull(offsets[7]),
    valor_deb: reader.readDoubleOrNull(offsets[8]),
  );
  object.id = id;
  return object;
}
