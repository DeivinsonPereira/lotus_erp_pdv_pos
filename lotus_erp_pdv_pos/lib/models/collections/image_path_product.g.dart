...
image_path_product _image_path_productDeserialize(
  ...
  final object = image_path_product(
    ...
    favorite: reader.readLongOrNull(offsets[1]),
    file_image: reader.readStringOrNull(offsets[2]),
    gtin: reader.readStringOrNull(offsets[3]),
    id_grupo: reader.readLongOrNull(offsets[4]),
    id_produto: reader.readLongOrNull(offsets[5]),
    path_image: reader.readStringOrNull(offsets[6]),
  );
  object.id = id;
  return object;
}
