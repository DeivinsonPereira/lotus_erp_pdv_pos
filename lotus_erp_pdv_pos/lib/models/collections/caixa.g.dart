...
caixa _caixaDeserialize(
  ...
  final object = caixa(
    abertura_data: reader.readDateTime(offsets[0]),
    abertura_hora: reader.readString(offsets[1]),
    abertura_id_user: reader.readLong(offsets[2]),
    abertura_valor: reader.readDouble(offsets[3]),
